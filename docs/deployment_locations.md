...
* k8s-certificate-authority-data: certificate (from kubeconfig file)
* k8s-client-certificate-data: client certificate (from kubeconfig file)
* k8s-client-key-data: client key (from kubeconfig file)
* k8s-token: access token (from kubeconfig file)
